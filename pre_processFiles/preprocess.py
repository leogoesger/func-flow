...
from gauge_reference import combined_gauges, old_gauges, new_gauges, gauge_reference_gauges
...
for root,dirs,files in os.walk(directory_name):
    for file in files:
       if file.endswith(end_with):
           ...
           if int(fixed_df.iloc[10,-1]) in gauge_reference_gauges:
               ...
               flow.iloc[0] = gauge_reference_gauges[int(file[:-4])]
